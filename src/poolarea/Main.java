...
public class Main {                                                                   //Class name
    public static void main(String[] args) {                                          //main method
        Rectangle rectangle = new Rectangle(5, 10);                        //Define value to integer
        System.out.println("rectangle.width = " + rectangle.getWidth());  // Print statement with method value from class Rectangular
        System.out.println("rectangle.length = " + rectangle.getLength()); // Print statement with method value from class Rectangular
        System.out.println("rectangle.area = " + rectangle.getArea()); // Print statement with method value from class Rectangular

        Cuboid cuboid = new Cuboid(5, 10, 5); // Define value to integer in different method
        System.out.println("cuboid.width =" + cuboid.getWidth()); // Print statement with method from class Rectangular
        System.out.println("cuboid.Length = " + cuboid.getLength()); // Print statement with method from class Rectangular
        System.out.println("cuboid.area = " + cuboid.getArea()); // Print statement with method from class Rectangular
