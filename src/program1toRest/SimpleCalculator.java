...
public class SimpleCalculator {
    ...
    public double getMultiplicatioResult() {
        return firstNumber * secondNumber;
    ...
    public static void main(String[] args) { //Main method
        ...
        System.out.println("substract = " + calculator.getSubstractionResult()); //Print statement
        calculator.setFirstNumber(5.25);
        calculator.setSecondNumber(0);
        System.out.println("multiply = " + calculator.getMultiplicatioResult()); //Print statement
        System.out.println("divide = " + calculator.getDivisionResult()); //Print statement
    }
}