...
public class Main {
    public static void main(String[] args) { //Main method
        ...
        System.out.println("circle.area = " + circle.getArea());//Print statement
        Cylinder cylinder = new Cylinder(5.55, 7.25);
        System.out.println("cylinder.radius = " + cylinder.getRadius()); //Print statement
        System.out.println("cylinder.height = " + cylinder.getHeight()); //Print statement
        System.out.println("cylinder.area = " + cylinder.getArea()); //Print statement
        System.out.println("Cylinder.volume = " + cylinder.getVolume()); //Print statement
    }
}
